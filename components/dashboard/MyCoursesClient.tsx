              ...
              <div className="space-y-1">
                {s.lessons.map((l) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-300 group-hover:text-purple-300 flex-1 line-clamp-1">{l.titleMn || l.title}</span>
...
export function MyCoursesClient({ active, inactive }: Props) {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-10">
      <h1 className="font-syne text-2xl font-bold text-white">Миний курсууд</h1>

      {/* Идэвхитэй */}
      {active.length > 0 && (
        <section>
          <div className="flex items-center gap-3 mb-5">
            <h2 className="font-syne text-lg font-semibold text-white">Идэвхитэй</h2>
      ...
      {inactive.length > 0 && (
        <section>
          <div className="flex items-center gap-3 mb-5">
            <h2 className="font-syne text-lg font-semibold text-white">Идэвхгүй</h2>
