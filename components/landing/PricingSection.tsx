    ...
    <section className="py-20 px-4 bg-gradient-to-b from-transparent to-[#0a0e1a]">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-[#111827] border border-white/10 rounded-2xl p-8 text-left">
            <div className="text-sm text-gray-400 mb-2">Тус бүрийн курс</div>
            <div className="font-syne text-4xl font-bold text-white mb-1">₮49,000+</div>
            <div className="text-sm text-gray-500 mb-6">нэг удаагийн төлбөр</div>
            ...
            <Link href="/courses" className="block text-center py-3 border border-white/10 text-gray-300 rounded-xl hover:bg-white/5 transition text-sm">
              Курс сонгох →
            </Link>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-600/20 to-cyan-500/20 border border-purple-500/30 rounded-2xl p-8 text-left relative overflow-hidden">
            ...
            <div className="text-sm text-gray-400 mb-2">Бүх курс багц</div>
            <div className="font-syne text-4xl font-bold text-white mb-1">₮299,000</div>
