  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-400 mt-1">Өнөөдөр юу сурах вэ?</p>
      </div>
      ...
      <div className="flex items-center justify-between mb-4">
        <h2 className="font-syne text-lg font-bold text-white">Миний курсууд</h2>
      ...
      {enrollments.length === 0 ? (
        <div className="bg-[#111827] border border-white/10 rounded-2xl p-12 text-center">
          ...
          <p className="text-gray-400 mb-4">Та одоогоор ямар нэг курст бүртгэгдээгүй байна</p>
          <Link
            href="/courses"
