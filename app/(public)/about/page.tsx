...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-[#0d1220]">
      <Navbar />
      <div className="pt-24 pb-12 px-4 max-w-4xl mx-auto">

        <div className="text-center py-12">
          <h1 className="font-syne text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white dark:bg-[#111827] border border-slate-200 dark:border-white/10 rounded-2xl p-8">
            ...
            <h2 className="font-syne text-xl font-bold text-slate-900 dark:text-white mb-3">Манай зорилго</h2>
          ...
          <div className="bg-white dark:bg-[#111827] border border-slate-200 dark:border-white/10 rounded-2xl p-8">
            <div className="text-3xl mb-4">🚀</div>
            <h2 className="font-syne text-xl font-bold text-slate-900 dark:text-white mb-3">Яагаад бид?</h2>
            <p className="text-slate-500 dark:text-gray-400 leading-relaxed">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
          {[
            ...
            <div key={label} className="bg-white dark:bg-[#111827] border border-slate-200 dark:border-white/10 rounded-2xl p-6 text-center">
        ...
        <div className="bg-white dark:bg-[#111827] border border-slate-200 dark:border-white/10 rounded-2xl p-8 mb-16">
          <h2 className="font-syne text-2xl font-bold text-slate-900 dark:text-white mb-6">Холбоо барих</h2>
          <div className="space-y-4 text-slate-500 dark:text-gray-400">
